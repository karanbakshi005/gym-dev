  ...
  return (
    <Swiper className="h-full">
      ...
      <SwiperNavButtons
        ...
        btnStyles="border border-brand text-white w-[56px] h-[56px] flex justify-center items-center hover:bg-brand transition-all duration-300"
        iconStyles="text-2xl"
      />
    </Swiper>
  );
